# windows-device-inventory Specification

## Purpose

Read-only Windows device enumeration, hotplug, system information, and platform
capability behavior. Windows maps native device facts into the shared model without
exposing platform property names to application or presentation layers.

# daemon-hardening Specification

## Purpose

Security hardening of `devmgrd`: a reviewed systemd sandbox, IPC input validation on every verb, and a privilege-minimization audit that the sandbox must match.

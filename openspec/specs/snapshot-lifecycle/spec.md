...
Daemon-side snapshot lifecycle: automatic pre-mutation snapshots, consistent capture under the apply mutex, atomic restore with hardware convergence, restore undoability, documented restore limits, and delete semantics.

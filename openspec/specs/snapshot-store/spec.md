...
On-disk snapshot store: JSON file format v1, content-hash identity and integrity quarantine, atomic write discipline, linear parent-chain history with HEAD, pruning policy, and hash-dedupe.

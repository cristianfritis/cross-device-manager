# snapshot-ipc Specification

## Purpose

D-Bus surface for snapshots: ApiVersion 3 additive verbs on `org.devmgr.Manager1`, polkit authorization mapping, and the error taxonomy for snapshot operations.

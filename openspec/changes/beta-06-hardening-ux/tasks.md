...
- [ ] 5.1 SBOM generation in the release workflow (syft SPDX + hand-maintained overlay for sdbus-c++/FTXUI/in-tree sha256) + dependency/license audit doc in the repo
